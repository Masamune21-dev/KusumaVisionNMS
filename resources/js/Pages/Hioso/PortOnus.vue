...
const submitRename = () => {
    ...
    router.post(route('hioso-olt.onu.info', [props.olt.id, props.slot, props.port, onu.onu_id]), { name: renameValue.value }, { preserveScroll: true });
};
        ...
        <template #header>
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    <Link :href="route('hioso-olt.detail', olt.id)" class="text-slate-400 hover:text-white">
