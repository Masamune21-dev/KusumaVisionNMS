...
const FEATURE_DEFS = [
    ...
    { icon: Network, accent: 'kv-circle-amber', badge: true, key: 'odp' },
    ...
    { icon: History, accent: 'kv-circle-emerald', key: 'backup' },
    ...
    { icon: Webhook, accent: 'kv-circle-purple', key: 'api' },
];
...
const modules = computed(() => [
    ...
    { icon: Waypoints, title: 'ODP', sub: t('welcome.m_odp_sub') },
